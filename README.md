...
直觉认为「细丝成束」能救——我们证明了相反的结论：**不换位的 Litz 束比等截面实心线还差 2.75%**（Rac/Rdc = 4.653 vs 4.5295，N=127 完整六角束，丝级 FEM）。外层丝链磁通少、阻抗低、抢流 4 倍（η_I=438%），环流把细丝的趋肤优势全部吃掉；且丝径再细也无济于事——失衡由束径决定，扫描证实 d→0.17 mm 后比值平台在实心线水平。
