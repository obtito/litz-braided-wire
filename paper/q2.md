...
未绞合束比实心**差 $+2.7\%$**（raw 口径 4.6527/4.5295=+2.72%；Richardson ≈4.65 口径 +2.6%；面积修正口径 +3.1%——三种口径并列报告，`data/q2_convergence.csv`）。
...
| 头条 4.6527（Richardson raw 4.648–4.651）、实心 4.5295/4.5310、束差 +2.7%（raw）~+3.1%（面积修正）、截断 −0.0007% | `data/q2_convergence.csv`、`data/q2_q3_baseline.json`、`findings.md` H+10 |
| 逐丝/环电流、$\eta_I$、环 6 FEM↔L1 +3.1%、角丝 5.38×、截断复核 | `data/q2_strand_currents.csv`、`data/q2_ring_currents.csv`、图 Q2-1/Q2-2、`q2_litz/impedance_model.py` |
